...
- Clone your fork using `git clone https://www.github.com/sricherry6/mlops-iris.git`
- Clone your fork  using `git clone https://www.github.com/sricherry6/mlops-iris.git`
- Install dependencies using `pip install -r requirements.txt`
- Run application using `python main.py`
- Run tests using `pytest`
- Update two more test cases
- Try execeuting a different classifier
...
## Assignment Tasks
1. Change this README to add your name here: Priyanka C. Add and commit changes to a new branch and create a pull request ONLY TO YOUR OWN FORK to see the CI/CD build happening. If the build succeeds, merge the pull request with master and see the CI/CD `upload_zip` take place.
